...
def attach_catalog_to_full(osc_df, my_catalog_df):
    """
    Enlaza cada fila de datos de Óscar con tu catálogo (por título normalizado + año).
...
with tab_awards:
    ...
    # --------- NUEVO: Estadísticas por categoría (ganadores) con Film / Name / Nominee ----------
