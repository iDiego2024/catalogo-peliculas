...
with tab_awards:
    ...
    # ========================================================
    #     GALERÍA VISUAL (TODOS LOS GANADORES DEL AÑO)
    # ========================================================
    ...
    # Fallback extra por si la columna de ganador viene rara
    if winners.empty:
...
"""
            ...
            cat_html = f"<b>Categoría:</b> {category}<br>" if category else ""
