...
"""
    ...
    def build_oscar_movie_card_html(
        ...
        NO toca nada del layout global: la clase principal es sólo 'movie-card'
        y el grid lo maneja el contenedor 'movie-gallery-grid' definido en tu CSS.
        """
        # Info TMDb
        poster_url = None
        tmdb_rating = None
        ...
        # Construcción segura del HTML (sin ternarios raros)
        parts = []
        parts.append(
    ...
    with tab_awards:
        ...
        if ff.empty:
            ...
            if not show_only_winners:
                ...
                for cat in cats_in_year:
                    ...
                    # Usamos tu clase global 'movie-gallery-grid' sin estilos inline:
                    cards_html = ["<div class='movie-gallery-grid'>"]
        ...
        # no sólo las filtradas por categoría/búsqueda.
